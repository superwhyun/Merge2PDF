      ...
      <div className="w-full max-w-3xl mx-auto">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-center mb-8 text-gray-600">
            드래그 & 드랍으로 PDF, 이미지(jpg, jpeg, png) 파일을 업로드하면 하나의 PDF로 합쳐드립니다.
          </p>
        </div>
        <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4 mb-6">
          <p className="text-yellow-800 text-sm">
            <strong>알림:</strong> PDF(.pdf), 이미지(.jpg, .jpeg, .png) 파일을 지원합니다.
          </p>
        </div>
        <div className="bg-blue-50 border border-blue-200 rounded-md p-4 mb-6">
          ...
          <ol className="list-decimal pl-5 text-blue-800 text-sm space-y-1">
            <li>PDF, 이미지(jpg, jpeg, png) 파일을 드래그하거나 클릭하여 업로드합니다.</li>
